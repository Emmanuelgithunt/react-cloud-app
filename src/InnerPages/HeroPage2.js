    ...
    <div className='w-full my-8'>
      <div className='max-w-[1240px] mx-auto'>
        <div className='text-center py-8'>
            ...
            <p className='text-3xl py-6 text-gray-600'>Transform images and video to load faster with no visual degradation, automatically generate image and video variants, and deliver high quality responsive experiences to increase conversions</p>
        </div>
        ...
        <div className='grid grid-cols-3 px-2 pt-4 text-center gap-4'>
            ...
            <div className='border py-8 rounded-xl shadow-2xl'>
                <p className='text-6xl font-bold text-indigo-600'>25%</p>
                <p className='text-gray-400 mt-2 font-bold'>Discount</p>
            </div>
